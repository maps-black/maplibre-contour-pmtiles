...
export type GetTileFunction = (z: number, x: number, y: number, demUrlPattern: string, abortController: AbortController, pmtiles?: PMTiles | null) => Promise<FetchResponse>;
